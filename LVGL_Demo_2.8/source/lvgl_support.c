...
#define COLOR_BUFFER  (DISP_HOR_RES * DISP_VER_RES)
/*******************************************************************************
* Global Variables
*******************************************************************************/
static lv_disp_drv_t disp_drv;

static lv_color_t disp_buf1[DISP_HOR_RES * DISP_VER_RES];
...
void lv_port_disp_init()
{
   ...
   // memset(disp_buf2, 0, sizeof(disp_buf2));
    ...
    lv_disp_draw_buf_init(&buf, disp_buf1, NULL, COLOR_BUFFER);
...
static void flush_cb(lv_disp_drv_t * drv, const lv_area_t * area, lv_color_t * color_p)
{
	lcd_fill_array_spi(area->x1, area->y1, area->x2, area->y2, color_p);// flush the ili9341
